# Suggested Commands: Quick Notes
Since this project has no build step or `package.json`, development is done by:
1. Editing the `.js`, `.css`, or `.html` files.
2. Navigating to `chrome://extensions` in Chrome.
